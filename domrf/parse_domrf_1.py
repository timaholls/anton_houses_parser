...
async def fetch_all_houses():
    ...
    while retry_count < MAX_RETRIES:
        ...
        try:
            ...
            try:
                await page1.goto(
                    "https://наш.дом.рф/сервисы/каталог-новостроек/список-объектов/список?objStatus=0&search=уфа",
            ...
            try:
                ...
                error_message = str(e)
                print(f"Ошибка при загрузке второй вкладки: {e}")
            ...
            while True:
                ...
                try:
                    ...
                    if api_errors >= max_api_errors:
                        print(f"Достигнуто максимальное количество ошибок API подряд ({max_api_errors}). Сохраняем прогресс и выходим.")
                        break
                    else:
