...
COOKIES = [
    {'name': 'adtech_uid', 'value': '956555b2-a1c0-4869-9711-aad49853daa0%3Adomclick.ru', 'domain': '.domclick.ru',
     'path': '/'},
    ...
    {'name': 'RETENTION_COOKIES_NAME', 'value': 'fdec34956162482380b8f19cdd92ad46:gMy0E3ELvVBN2W_xUB1BCHKk94s',
     'domain': '.domclick.ru', 'path': '/'},
    {'name': 'sessionId', 'value': '332e995495654d16876ddfa0b43929d9:SafvGzdIYWwCRP7iDkbFHePoMLI',
     'domain': '.domclick.ru', 'path': '/'},
    {'name': 'UNIQ_SESSION_ID', 'value': '0d5e5a921bb64bc1b8b645eb59b5921f:8YnvhGNM8tfIwu_0loyDOk2zSx4',
     'domain': '.domclick.ru', 'path': '/'},
    {'name': 'regionAlert', 'value': '1', 'domain': '.domclick.ru', 'path': '/'},
    {'name': 'currentLocalityGuid', 'value': '857c0a08-7dc0-445e-a044-ed2f6d435a7b', 'domain': '.domclick.ru',
     'path': '/'},
    {'name': 'currentRegionGuid', 'value': '1691f4a5-8e87-41ab-b0d3-05a0c7a07c76', 'domain': '.domclick.ru',
     'path': '/'},
    {'name': 'currentSubDomain', 'value': 'ufa', 'domain': '.domclick.ru', 'path': '/'},
    {'name': 'regionName', 'value': '857c0a08-7dc0-445e-a044-ed2f6d435a7b:%D0%A3%D1%84%D0%B0', 'domain': '.domclick.ru',
     'path': '/'},
    ...
    {'name': 'qrator_jsr',
     'value': 'v2.0.1761037620.947.88a9ad25rDzYOeVe|4LxD3bxKS6L6XoyR|VnC9cWvf5bV6F0IdpH3c9+yGXDLzjgNwZHwLJVNbjSXykIuoMAAYk5vr7Ss6vTk/SDXX/10jqieGYoz97fF12A==-P5YitRwSbxqF+YQanwdL6UxBLEo=-00',
     'domain': '.domclick.ru', 'path': '/'},
    {'name': 'qrator_jsid2',
     'value': 'v2.0.1761037620.947.88a9ad25rDzYOeVe|MRXDyas0iEJzZVU7|3tJ2Kx3Q0+T+bpfvj5LpWymrdKwPZjUv+HpAl1r1JUSGVuFRRx5ysqoEAtHqvq3R7A3wNcrA9Xsu5Wqlu14KY9KIcKICE5Zc58ewMQYPMMBVJwB6/SqQUPAPXF+eeNqUNAxr34uznBF2bZj/bTlFPg==-EAJMOdGEXhgch6jfBf3LJ46ZYh8=',
     'domain': '.domclick.ru', 'path': '/'},
    {'name': 'project-3518', 'value': '1148898-3', 'domain': '.domclick.ru', 'path': '/'},
    {'name': 'tmr_detect', 'value': '0%7C1761037628523', 'domain': '.domclick.ru', 'path': '/'},
    {'name': 't3_sid_7711713', 'value': 's1.2069167602.1761037622980.1761037634519.9.5.1.0..', 'domain': '.domclick.ru',
     'path': '/'},
...
async def restart_browser(old_browser, headless: bool = False, set_domclick_cookies: bool = False):
    """
    ...
    Args:
        ...
        set_domclick_cookies: Устанавливать ли cookies для domclick.ru (по умолчанию False)
    ...
    try:
        ...
        new_page = await create_browser_page(new_browser, set_domclick_cookies=set_domclick_cookies)
